...
export const notification: NotificationSummary = {
  ...
  payload: {
    ...
    entity_type: 'event',
    entity_key: '10000000-0000-4000-8000-000000000021',
    action_path: '/events/10000000-0000-4000-8000-000000000021',
    event_status: 'draft',
...
export function notificationPreview(locale: 'de' | 'da' | 'en') {
  const subject = {
  ...
  return {
    subject,
    text: `${subject}\nKulturverein`,
    html: `<!doctype html><html lang="${locale}"><head></head><body><p>${subject}</p></body></html>`,
    locale,
